...
class VMWriter {
    ...
    public void writeterm(Node n) {
        ...
        if (nList.getLength() == 1) {
            if (nList.item(0).getNodeName().equals("stringConstant")) {
                ...
                if (nList.item(0).getTextContent().equals(" null ")
                        || nList.item(0).getTextContent().equals(" false ")) {
            ...
            if (nList.item(1).getTextContent().equals(" [ ")) {
                ...
                if (c.contains(".")) {
                    ...
                    if (!st.gettype(str).equals("")) {
                        sb.append("call " + st.gettype(str) + "." + c.substring(o + 1, c.length()) + " "
                                + (CompilationEngine.countexpressionlist + 1) + "\n");
                    } else {
    ...
    public void defineOS() {
        os.put("Math.init", "call Math.init 0");
        os.put("Math.abs", "call Math.abs 1");
        os.put("Math.multiply", "call Math.multiply 2");
        os.put("Math.divide", "call Math.divide 2");
        os.put("Math.min", "call Math.min 2");
        os.put("Math.max", "call Math.max 2");
        os.put("Math.sqrt", "call Math.sqrt 1");

        os.put("Array.new", "call Array.new 1");

        os.put("Output.init", "call Output.init 0");
        os.put("Output.moveCursor", "call Output.moveCursor 2");
        os.put("Output.printChar", "call Output.printChar 1");
        os.put("Output.printString", "call Output.printString 1");
        os.put("Output.printInt", "call Output.printInt 1");
        os.put("Output.println", "call Output.println 0");
        os.put("Output.backSpace", "call Output.Space 0");

        os.put("Keyboard.init", "call Keyboard.init 0");
        os.put("Keyboard.keyPressed", "call Keyboard.keyPressed 0");
        os.put("Keyboard.readChar", "call Keyboard.readChar 0");
        os.put("Keyboard.readLine", "call Keyboard.readLine 1");
        os.put("Keyboard.readInt", "call Keyboard.readInt 1");
